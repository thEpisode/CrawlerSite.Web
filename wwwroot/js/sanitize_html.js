...
$Flinger.SanitizeHTML = {
    _sanitizer: {},
    Initialize: function () {
        this._sanitizer = new HtmlWhitelistedSanitizer(true);
    },
    Sanitize: function (html) {
        if (html !== undefined && html !== null) {
            if (this.CheckIsHTML(html)) {
                return this._sanitizer.sanitizeString(html);
            }
            else {
                return html;
            }
...
$Flinger.SanitizeHTML.Initialize();